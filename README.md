...
# Store BackGround 
A retail Store chain sales Transaction, including order_details, customer_info, product_category, Order_Times, Order_status
The business want to optimize operations, improve customer experiance, and increasing profitability using data_driven decisions .
